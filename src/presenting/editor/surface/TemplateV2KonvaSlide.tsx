...
} from "@/presenting/editor/text/google-fonts";
import {
  canUngroupTemplateV2Component,
  ungroupTemplateV2ComponentInUi,
} from "@/presenting/editor/model/template-v2-ungroup";
import {
  groupTemplateV2ComponentsInUi,
  isTemplateV2GroupShortcut,
} from "@/presenting/editor/model/template-v2-group";
import { textRunsContent } from "@/presenting/editor/text/text-runs";
...
import { ChartDataEditorPopover } from "@/presenting/editor/charts/ChartEditorContent";
import { TableInlineEditor } from "@/presenting/editor/tables/TableInlineEditor";
import { TemplateV2InlineEditor } from "@/presenting/editor/text/TemplateV2InlineEditor";
import {
  measureWordWrappedTextRunsHeight,
  type TemplateV2InlineEditBox,
  type TemplateV2TextEditStyle,
  wordWrappedTextRuns,
} from "@/presenting/editor/text/template-v2-text-editing";


import { updateSlideUi } from "@/presenting/state/slices/presentationGeneration";
import { useNearViewport } from "@/app/hooks/useNearViewport";
import { resolveBackendAssetSource } from "@/utils/api";
import { bucketFileSize, sanitizeAnalyticsError } from "@/presenting/editor/utils/analytics";
import { MixpanelEvent, trackEvent } from "@/presenting/editor/utils/mixpanel";
import { ImagesApi } from "@/app/(presentation-generator)/services/api/images";
import IconsEditor from "@/presenting/editor/images/IconsEditor";
import {
  createTemplateV2ClipboardPayload,
  pasteTemplateV2ClipboardPayload,
  type TemplateV2ClipboardPayload,
} from "@/presenting/editor/clipboard/clipboard";
import { useTemplateV2Clipboard } from "@/presenting/editor/clipboard/useClipboard";
import {
...
import { TemplateV2SelectionToolbar } from "@/presenting/editor/selection/SelectionToolbar";
import {
...
} from "@/presenting/editor/selection/toolbarPosition";
import {
...
import { updateComponentLayoutElement } from "@/presenting/editor/layout/layoutResize";
import {
  componentLayerActionForShortcut,
  reorderComponentLayer,
  type ComponentLayerAction,
} from "@/presenting/editor/selection/layering";
import { TemplateV2SelectionTransformers } from "@/presenting/editor/selection/SelectionTransformers";
import { useFontLoadState } from "@/presenting/editor/surface/fontLoading";
import {
...
} from "@/presenting/editor/surface/pixelRatio";
import {
  createAlignmentSnapTargets,
  snapBoxToAlignmentGuides,
  type AlignmentGuide,
  type AlignmentSnapTargets,
} from "@/presenting/editor/surface/alignmentGuides";
import {
  MemoizedRawComponentNode,
  MemoizedRawElementNode,
} from "@/presenting/editor/surface/nodes";
import {
  MAX_HISTORY_ENTRIES,
  ...
  type Selection,
  type UnknownRecord,
} from "@/presenting/editor/model/model";
import {
...
} from "@/presenting/editor/events/events";
