...
import type { TextSlideElement } from "@/presenting/editor/state/state";
import { withHash } from "@/presenting/editor/utils/color";
import type { Font, Marker } from "@/presenting/editor/types";
import {
  elementFont,
  mergeFont,
  mergeFontForTextSelection,
} from "@/presenting/editor/model/element-model";
import {
...
import { DeferredColorInput } from "@/presenting/editor/toolbar/DeferredColorInput";
import {
  FloatingToolbarBoundsProvider,
  FloatingToolbarPanel,
} from "@/presenting/editor/toolbar/FloatingToolbar";
import {
  ComponentActionsMenu,
  ComponentUngroupButton,
  type ComponentActionsMenuActions,
} from "@/presenting/editor/selection/ComponentActionsMenu";
import {
  numericInputMode,
