// Consumed live by TemplateV2KonvaSlide.tsx (dispatch) and PresentingPanel.tsx
// (listener) — despite this file's neighbors under editor/ still carrying
// stale "not imported by the embedded panel" comments from an earlier port.
import type { SlideElement } from "@/presenting/editor/types";

export const TEMPLATE_V2_INSERT_ELEMENTS_EVENT = "presenton:template-v2-insert-elements";
export const TEMPLATE_V2_SURFACE_SELECTED_EVENT = "presenton:template-v2-surface-selected";
export const TEMPLATE_V2_ACTIVATE_SURFACE_EVENT = "presenton:template-v2-activate-surface";
