...
// ---------------------------------------------------------------------------
// Radix UI compat exports for the Presenting sub-tree
// These forward to the native Radix Dialog primitive that ships with
// @radix-ui/react-dialog (installed for the editor port).
// ---------------------------------------------------------------------------
